...
We can also use the excellent `DHARMa` `r emo::ji("package")` [@DHARMa] to evaluate fit of *glm* and *glmm*. So instead of using the function `overdisp_fun()`, we can simply use the function `testDispersion()`.
