...
```{r plot_aggr, echo=TRUE, eval = FALSE}
...
```{r r_plot_aggr, ref.label=c("plot_aggr"), echo = FALSE, eval = TRUE, warning = FALSE, fig.cap = "Unicorn aggressivity as a function of opponent size when fighting for sweets", fig.height=4, fig.width=5, fig.align='center'}
```
...
4. Homscedasticty (variance of residuals is constant across covariates)
