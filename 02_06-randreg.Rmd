...
wald(rr_asr, ssType = "conditional", denDF = "numeric")
```

```{r, echo = FALSE, eval = htmlF_pdfT, purl = FALSE}
summary(rr_asr, coef = TRUE)$coef.fixed
wa <- wald(rr_asr, ssType = "conditional", denDF = "numeric")$Wald
...
wald(cs_asr, ssType = "conditional", denDF = "numeric")
```

```{r, echo = FALSE, eval = htmlF_pdfT, purl = FALSE}
summary(cs_asr, all = T)$coef.fixed
wa <- wald(cs_asr, ssType = "conditional", denDF = "numeric")$Wald
attr(wa, "heading") <- NULL
wa
```
