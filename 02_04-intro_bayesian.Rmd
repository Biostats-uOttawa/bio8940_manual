...
knitr::include_graphics("images/bayestriptic.svg")
```
...
**brms** is an acronym for *Bayesian Regression Models using 'Stan'* [@Rbrms]. It is a package developed to fit regression models with a Bayesian approach using the amazing `stan` software [@stan2021]. 
...
2. it is incredibly flexible since it is essentially a front end for `stan` [@stan2021] [@RStan]
